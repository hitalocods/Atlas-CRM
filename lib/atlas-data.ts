...
export const initialTasks: Task[] = [
  {
    id: "tk_1",
    title: "Send Northstar packet",
    description: "Prepare the client review packet and confirm the next feedback window.",
    projectId: "pr_creator",
    status: "todo",
    priority: "high",
    due: "Today",
    reminder: "09:30",
    checklist: [
      { id: "tk_1_1", title: "Export screens", done: true },
      { id: "tk_1_2", title: "Write summary", done: false },
      { id: "tk_1_3", title: "Send email", done: false },
    ],
  },
  {
    id: "tk_2",
    title: "Close Supabase schema pass",
    description: "Review table fields, policies and generated database types before deploy.",
    projectId: "pr_atlas",
    status: "in_progress",
    priority: "urgent",
    due: "Today",
    reminder: "11:00",
    checklist: [
      { id: "tk_2_1", title: "Validate schema.sql", done: true },
      { id: "tk_2_2", title: "Check auth policies", done: false },
    ],
  },
  {
    id: "tk_3",
    title: "Reconcile May expenses",
    description: "Confirm paid tools, scheduled contractors and pending invoices.",
    status: "todo",
    priority: "medium",
    due: "Tomorrow",
    reminder: "14:00",
    checklist: [
      { id: "tk_3_1", title: "Review subscriptions", done: false },
      { id: "tk_3_2", title: "Tag expenses", done: false },
    ],
  },
  {
    id: "tk_4",
    title: "Archive old client credentials",
    description: "Move legacy credentials out of the active vault view.",
    status: "done",
    priority: "low",
    due: "May 13",
    reminder: "Done",
    checklist: [
      { id: "tk_4_1", title: "Confirm replacement login", done: true },
      { id: "tk_4_2", title: "Archive vault item", done: true },
    ],
  },
];
